            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        u = _a.sent();
                        if (u)
                            return [2 /*return*/, res.status(400).json("Account with email ".concat(body.email, " already exists."))];
                        user = new User(body);
                        user.save()
                            .then(function () {
                            res.status(200).json("User with email ".concat(body.email, " created successfully."));
                        })
                            .catch(function (err) {
                            return res.status(500).json(err);
                        });
        ...
        this.getUserByEmail = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                User.findOne({ email: email })
                    ...
                    return res.status(404).json("User with email ".concat(email, " not found"));
                })
                    .catch(function (err) {
